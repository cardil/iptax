...
def build_judgment_prompt(
    ...
    prompt_parts.extend(
        [
            ...
            "```yaml",
            "judgments:",
            '  - change_id: "host.com/owner/repo#123"  # Use EXACT change_id from above',
            "    decision: INCLUDE  # or EXCLUDE or UNCERTAIN",
            "    reasoning: Brief explanation of why this change belongs or doesn't",
            "```",
            "",
            "IMPORTANT: The change_id must match EXACTLY as shown above (including host/path#number).",
            "",
            "Decisions:",
